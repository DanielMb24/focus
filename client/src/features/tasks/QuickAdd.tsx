...
export function QuickAdd() {
  ...
  return (
    <div role="dialog" aria-modal="true" aria-label="Nouvelle tâche" className="animate-overlay fixed inset-0 z-50 flex items-end justify-center bg-stone-950/50 p-0 sm:items-center sm:p-4" onClick={() => setQuickAdd(false)}>
